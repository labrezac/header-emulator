...
def test_load_profiles_raises_without_user_agent(monkeypatch):
    monkeypatch.setattr(profile_loader, "_read_file", lambda path: {"user_agents": []})
    with pytest.raises(RuntimeError):
        profile_loader.load_profiles("dummy.json")
